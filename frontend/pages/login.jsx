  ...
  return (
    <div className="glass-bg">
      <form className="glass-form" onSubmit={handleSubmit}>
        ...
        <div className="form-title">Login to NBK Pay</div>
        <label>
          Terminal ID
          <select
            value={terminal}
        ...
        <div className="login-links">
          ...
          <Link href="/change-password" className="link">Change Password</Link>
          <Link href="/master-reset" className="link master">Master Password Reset</Link>
        </div>
      ...
      <style jsx>{`
        ...
        .link.master { color: #fff; background: #d7263d; border-radius: 6px; padding: 3px 7px;}
        .btn.primary {
          width: 100%;
